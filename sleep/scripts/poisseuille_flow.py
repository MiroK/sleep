# This script aims to compute the poisseuille flow due to a pressure difference at the entrance and at the exit of the fluid domain
# We use the fluid solve
...
uf_bottom = Expression(('0','0'), time = 0, degree=2)   # no slip condition at the bottom
